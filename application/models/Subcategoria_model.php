...
class Subcategoria_model extends CI_Model {
	...
	var $column_search = array('categorias.nombre','subcategorias.nombre'); //set column field database for datatable searchable just firstname , lastname , address are searchable
