...
class Compra extends MY_Controller {
...

	{
		...
		$this->load->model('compra_renglones_model','compra_renglones');

		$this->load->model('producto_model','producto');
		
		$this->load->model('pago_model','pago');
		
		$this->load->model('aplicacionpagocompra_model','aplicacionPagoCompra');

		$this->load->model('transaccion_model','transaccion');

		//$this->load->model('Comentarioproveedor_model','Comentarioproveedor');

		$this->load->model('enviocompra_model','enviocompra');
	}
	...
	public function cargar_venta($id){
		...
		if(count($data['envio']->nombre_envio)>0){
