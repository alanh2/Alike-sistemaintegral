        <div id="page-wrapper">
            ...
            <h3>Rubros</h3>
            <br />
            <button id="agregar" class="btn btn-success" onclick="add_rubro()"><i class="glyphicon glyphicon-plus"></i> Agregar Rubro</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('rubro/ajax_list')?>",
            "type": "POST"
        },
...
function add_rubro()
{
    ...
    $('.modal-title').text('Agregar Rubro'); // Set Title to Bootstrap modal title
}
...
function edit_rubro(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('rubro/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
function save()
{
    ...
    if(save_method == 'add') {
        url = "<?php echo site_url('rubro/ajax_add')?>";
    } else {
        url = "<?php echo site_url('rubro/ajax_update')?>";
    }
...
{
    if(confirm('Esta seguro que desea borrar esta rubro?'))
    {
        // ajax delete data to database
        $.ajax({
            url : "<?php echo site_url('rubro/ajax_delete')?>/"+id,
            type: "POST",
            dataType: "JSON",
            success: function(data)
            {
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title">Formulario de Rubro</h3>
            </div>
