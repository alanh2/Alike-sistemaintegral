        <div id="page-wrapper">
            ...
            <h3>Marcas</h3>
            <br />
            <button id="agregar" class="btn btn-success" onclick="add_marca()"><i class="glyphicon glyphicon-plus"></i> Agregar Marca</button>
...
$(document).ready(function() {
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('marca/ajax_list')?>",
            "type": "POST"
        },
...
function edit_marca(id)
{
    ...
    $.ajax({
        url : "<?php echo site_url('marca/ajax_edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
...
{
    if(confirm('Esta seguro que desea borrar esta marca?'))
    {
