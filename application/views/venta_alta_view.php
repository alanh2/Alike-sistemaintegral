            ...
            <div class="row menuVentas">
                <div class="col-lg-3 col-md-3 col-md-3 col-xs-3">
                    <div class="panel panel-red">
                        ...
                        <a href="http://systemix.com.ar/sistemaIntegral/index.php/venta/alta_venta/<?php echo $ventaid;?>">
                ...
                <div class="col-lg-3 col-md-3 col-md-3 col-xs-3">
                    <div class="panel panel-red">
                        ...
                        <a href="http://systemix.com.ar/sistemaIntegral/index.php/venta/renglones_venta/<?php echo $ventaid;?>">
                            <div class="panel-footer">
                                <span class="pull-left hidden-xs">Modificar</span>
                                <span class="pull-right"><i class="fa fa-arrow-circle-right"></i></span>
                                <div class="clearfix"></div>
                ...
                <div class="col-lg-3 col-md-3 col-md-3 col-xs-3">
                    <div class="panel panel-red">
                        ...
                        <a href="http://systemix.com.ar/sistemaIntegral/index.php/venta/metodo_pago_venta/<?php echo $ventaid;?>">
                            <div class="panel-footer">
                ...
                <div class="col-lg-3 col-md-3 col-md-3 col-xs-3">
                    <div class="panel panel-red">
                        ...
                        <a href="http://systemix.com.ar/sistemaIntegral/index.php/venta/envios_venta/<?php echo $ventaid;?>">
                            <div class="panel-footer">
