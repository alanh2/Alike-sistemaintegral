...
{
    var $table = 'usuarios';
    var $column_order = array('id','nombre','clave',null); //set column field database for datatable orderable
    var $column_search = array('id','nombre','clave'); //set column field database for datatable searchable just firstname , lastname , address are searchable
    ...
    public function getPassword($usuarioid){
        $this->db->from($this->table);
    ...
    public function changePassword($data){
        $sql = "UPDATE usuarios SET clave = '".$data['newpassword']."' WHERE id = '".$data['id']."' ";
